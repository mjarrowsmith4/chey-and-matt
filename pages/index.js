            ...
            <div className="block-column_large">
              <ul>
                <li>
                  ...
                  <span className="event">Wedding Ceremony</span>
                </li>
                <li>
                  <span className="time">1:45pm</span>
                  <span className="event">Canapés</span>
                </li>
                <li>
                  <span className="time">3pm</span>
                  <span className="event">Wedding Breakfast</span>
                </li>
                <li>
                  <span className="time">5:15pm</span>
                  <span className="event">Speeches</span>
                </li>
                <li>
